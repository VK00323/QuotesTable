...
data class QuotesUpdatesData(
    ...
    @SerializedName("bbs") val bbs: Double?, // Best bid size
    ...
    @SerializedName("bas") val bas: Double?, // Best offer size
    ...
    @SerializedName("lts") val lts: Double?, // Last trade size
    ...
    @SerializedName("vol") val vol: Double?, // Trade volume per day in pcs
    ...
    @SerializedName("cpp") val cpp: Double?, // Coupon period
    ...
    @SerializedName("trades") val trades: Double?, // Number of trades
